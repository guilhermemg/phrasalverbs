...
def get_phrasal_verbs():
    arq = open("phrasal_verbs","r")
    phrasal_verbs = []
    for i in range(62):
        phrasal_verb = arq.readline().strip()
        exemplo_parte_1 = arq.readline().strip()
        if exemplo_parte_1 == "...":
            exemplo_parte_1 = -1
        verbo = arq.readline().strip()
        exemplo_parte_2 = arq.readline().strip()
        if exemplo_parte_2 == "...":
            exemplo_parte_2 = -1
        particula = arq.readline().strip()
        exemplo_parte_3 = arq.readline().strip()
        if exemplo_parte_3 == "...":
            exemplo_parte_3 = -1
        phrasal_verbs.append({'phrasal_verb' : phrasal_verb, 'exemplo_parte_1' : exemplo_parte_1, 'verbo' : verbo, 'exemplo_parte_2' : exemplo_parte_2, 'particula' : particula, 'exemplo_parte_3' : exemplo_parte_3})
